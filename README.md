...
## Environments
- Preview: https://main--fileupload--lovelymandal16.hlx.page/
- Live: https://main--fileupload--lovelymandal16.hlx.live/
...
1. Open the `fileupload` directory in your favorite IDE and start coding :)
